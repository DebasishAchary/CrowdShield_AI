...
def start_tracker():
    """
    Start the crowd tracking and analytics pipeline.
    This function runs in a separate thread and continuously processes video frames.
    """
    ...
    while True:
        ...
        print("API Updated:", state.latest_data)
